locals {
  discord_downloads_webhook  = data.sops_file.secrets.data.discord_downloads_webhook
  discord_monitoring_webhook = data.sops_file.secrets.data.discord_monitoring_webhook
}
...
module "sonarr_anime" {
  ...
  discord_downloads_web_hook_url  = local.discord_downloads_webhook
  discord_monitoring_web_hook_url = local.discord_monitoring_webhook
  providers = {
    sonarr = sonarr.anime
  }
}
